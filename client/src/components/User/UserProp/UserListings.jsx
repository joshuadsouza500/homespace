...
const UserListings = () => {
  ...
  return (
    <div className="container mx-auto px-4 lg:px-6 pt-4 lg:pt-6 pb-8 bg-estate-50 dark:bg-[#121212] h-full">
      <div
          ...
          currentProperties && currentProperties.length > 0 ? (
            currentProperties.map((property) => (
              <PropertyCard
                ...
                update={true}
                property={property}
                className="md:max-w-2xl mx-1 md:h-64 2xl:h-64 backdrop-blur-md  border-black/5 dark:border-white/10 border"
              />
            ))
          ) : (
