...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 ease-in-out  focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          " text-primary-foreground bg-Primary hover:indigo-700 hover:scale-[.99] hover:shadow-sm",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-input bg-muted  hover:bg-accent hover:text-accent-foreground dark:bg-[#222222] dark:text-[#F8FDFF]  dark:border-[#4D4D4E] muted-foreground [] dark:hover:bg-[#222222] dark:hover:text-[#F8FDFF] ",
        secondary:
